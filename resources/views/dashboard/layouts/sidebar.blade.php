<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ url(" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html ") }}" target="_blank">
        <span class="ms-1 font-weight-bold">Bus Tracker</span>
      </a>
    </div>
