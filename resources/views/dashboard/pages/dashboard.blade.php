              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="{{ url("javascript:;") }}">
                      Read More
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                ...
                <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="{{ url("javascript:;") }}">
                  Read More
                  <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
                </a>
              </div>
                ...
                <div class="col-lg-6 col-5 my-auto text-end">
                  <div class="dropdown float-lg-end pe-4">
                    ...
                    <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
                      <li><a class="dropdown-item border-radius-md" href="{{ url("javascript:;") }}">Action</a></li>
                      <li><a class="dropdown-item border-radius-md" href="{{ url("javascript:;") }}">Another action</a></li>
                      <li><a class="dropdown-item border-radius-md" href="{{ url("javascript:;") }}">Something else here</a></li>
                    </ul>
                  </div>
                </div>
              </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="avatar-group mt-2">
                          <a href="{{ url("javascript:;") }}" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                            <img src="{{ asset("/../assets/img/team-1.jpg") }}" alt="team1">
                          </a>
                          <a href="{{ url("javascript:;") }}" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                            <img src="{{ asset("/../assets/img/team-2.jpg") }}" alt="team2">
                          </a>
                          <a href="{{ url("javascript:;") }}" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Alexander Smith">
                            <img src="{{ asset("/../assets/img/team-3.jpg") }}" alt="team3">
                          </a>
                          <a href="{{ url("javascript:;") }}" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
